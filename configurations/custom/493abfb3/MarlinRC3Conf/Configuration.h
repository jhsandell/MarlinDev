...
#define STRING_CONFIG_H_AUTHOR "(Hubert, Orbit-A)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Orbit-A"
...
#define PREVENT_DANGEROUS_EXTRUDE // Commenter pour DEMO
//if PREVENT_DANGEROUS_EXTRUDE is on, you can still disable (uncomment) very long bits of extrusion separately.
#define PREVENT_LENGTHY_EXTRUDE // Commenter pour DEMO

#define EXTRUDE_MINTEMP 170 // Commenter pour DEMO
//#define EXTRUDE_MINTEMP 10 // Pour DEMO
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 75 // Passe de 200 a 100 pour corriger les accoups
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 167 // mm 170.00 --> 169.5 --> 163 après mesure ! --> 167
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 319 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {NB_MICROSTEPS,NB_MICROSTEPS,NB_MICROSTEPS,NB_MICROSTEPS_EXTRUDER}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {9000, 9000, 9000, 250}    // (mm/sec)
